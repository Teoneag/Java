...
public class Character implements Serializable /* We have to implement Serializable for ObjectStreams to work */ {

    private final String name;
    private int level;
    private double xpPoints;

    private transient String playerSecret = null; // Transient will make sure this field will not be serialized
